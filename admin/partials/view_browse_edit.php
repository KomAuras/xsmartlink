<div class="wrap">
    ...
    <table class="form-table">
        <tr valign="top">
            ...
            <td><input style="width:50%" type="text" name="anchor_value" id="anchor_value" value="<?=$edit_row->value;?>" class="regular-text code"/>
        ...
        <tr valign="top">
            ...
            <td><input style="width:50%" type="text" name="anchor_link" id="anchor_link" value="<?=$edit_row->link;?>" class="regular-text code" READONLY/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label for="anchor_required"><?= _e('Required qty','xlinks')?> <span class="description"><?php _e('(required)'); ?></span></label></th>
            <td><input style="width:50px" type="text" name="anchor_required" id="anchor_required" value="<?=$edit_row->req;?>" class="regular-text code"/>
